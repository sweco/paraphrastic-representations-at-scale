...
paranmt_location = os.environ.get('SM_CHANNEL_PARANMT', '../../datasets/paranmt')
sentencepiece_location = os.environ.get('SM_CHANNEL_SENTENCEPIECE', '../paraphrase-at-scale-english-models')

parser = argparse.ArgumentParser()

parser.add_argument("--data-file", default=f'{paranmt_location}/paranmt.sim-low=0.4-sim-high=1.0-ovl=0.7.final.h5', help="training data")
...
parser.add_argument("--batchsize", default=256, type=int, help="size of batches")
...
parser.add_argument("--report-interval", type=int, default=100, help="frequency (in batches) to report training status of epoch")
...
parser.add_argument("--sp-model", default=f'{sentencepiece_location}/paranmt.model', help="SP model to load for evaluation")
